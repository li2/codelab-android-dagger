 ...
 */
// You don't need the @ActivityScoped annotation since with the extension methods
// viewModels() and activityViewModels(), you can control the scope of this ViewModel.
// @ActivityScoped
@HiltViewModel
